...
def download_segmentation(station, flag1, indx):
    if flag1 != "m":
        st_dates, end_dates = noaapy.date.date_range_segmentation(station, flag1, indx)
    else:
        print(station)
        print(indx)
        st_dates = station["start_date"][indx]
        end_dates = station["end_date"][indx]
